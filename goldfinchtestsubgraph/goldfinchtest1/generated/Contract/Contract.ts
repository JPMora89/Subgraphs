...
export class Contract__availableToWithdrawResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__getAmountsOwedResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Contract__getTrancheResultValue0Struct extends ethereum.Tuple {
  get id(): BigInt {
...
export class Contract__payResultValue0Struct extends ethereum.Tuple {
...
export class Contract__pay1ResultValue0Struct extends ethereum.Tuple {
  get owedInterestPayment(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__poolSlicesResultValue0Struct extends ethereum.Tuple {
  get seniorTranche(): Contract__poolSlicesResultValue0SeniorTrancheStruct {
    return changetype<Contract__poolSlicesResultValue0SeniorTrancheStruct>(
      this[0].toTuple()
    );
  }

  get juniorTranche(): Contract__poolSlicesResultValue0JuniorTrancheStruct {
    return changetype<Contract__poolSlicesResultValue0JuniorTrancheStruct>(
      this[1].toTuple()
    );
  }
...
export class Contract__poolSlicesResultValue0SeniorTrancheStruct extends ethereum.Tuple {
  get id(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__poolSlicesResultValue0JuniorTrancheStruct extends ethereum.Tuple {
  get id(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__withdrawResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__withdrawMaxResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  availableToWithdraw(tokenId: BigInt): Contract__availableToWithdrawResult {
    let result = super.call(
      "availableToWithdraw",
    ...
    return new Contract__availableToWithdrawResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_availableToWithdraw(
    tokenId: BigInt
  ): ethereum.CallResult<Contract__availableToWithdrawResult> {
    let result = super.tryCall(
      "availableToWithdraw",
      "availableToWithdraw(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      new Contract__availableToWithdrawResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getAmountsOwed(timestamp: BigInt): Contract__getAmountsOwedResult {
    let result = super.call(
      "getAmountsOwed",
    ...
    return new Contract__getAmountsOwedResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getAmountsOwed(
    timestamp: BigInt
  ): ethereum.CallResult<Contract__getAmountsOwedResult> {
    let result = super.tryCall(
      "getAmountsOwed",
      "getAmountsOwed(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(timestamp)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getAmountsOwedResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getTranche(tranche: BigInt): Contract__getTrancheResultValue0Struct {
    let result = super.call(
      "getTranche",
    ...
    return changetype<Contract__getTrancheResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getTranche(
    tranche: BigInt
  ): ethereum.CallResult<Contract__getTrancheResultValue0Struct> {
    let result = super.tryCall(
      "getTranche",
      "getTranche(uint256):((uint256,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tranche)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__getTrancheResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  pay(amount: BigInt): Contract__payResultValue0Struct {
    let result = super.call(
      "pay",
    ...
    return changetype<Contract__payResultValue0Struct>(result[0].toTuple());
  }

  try_pay(
    amount: BigInt
  ): ethereum.CallResult<Contract__payResultValue0Struct> {
    let result = super.tryCall(
      "pay",
      "pay(uint256):((uint256,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(amount)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__payResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  pay1(
  ...
  ): Contract__pay1ResultValue0Struct {
    let result = super.call(
      "pay",
    ...
    return changetype<Contract__pay1ResultValue0Struct>(result[0].toTuple());
  }

  try_pay1(
    principalAmount: BigInt,
    interestAmount: BigInt
  ): ethereum.CallResult<Contract__pay1ResultValue0Struct> {
    let result = super.tryCall(
      "pay",
      "pay(uint256,uint256):((uint256,uint256,uint256,uint256,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__pay1ResultValue0Struct>(value[0].toTuple())
    );
  }

  poolSlices(index: BigInt): Contract__poolSlicesResultValue0Struct {
    let result = super.call(
      "poolSlices",
    ...
    return changetype<Contract__poolSlicesResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_poolSlices(
    index: BigInt
  ): ethereum.CallResult<Contract__poolSlicesResultValue0Struct> {
    let result = super.tryCall(
      "poolSlices",
      "poolSlices(uint256):(((uint256,uint256,uint256,uint256,uint256),(uint256,uint256,uint256,uint256,uint256),uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(index)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__poolSlicesResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  withdraw(tokenId: BigInt, amount: BigInt): Contract__withdrawResult {
    let result = super.call(
      "withdraw",
    ...
    return new Contract__withdrawResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_withdraw(
    tokenId: BigInt,
    amount: BigInt
  ): ethereum.CallResult<Contract__withdrawResult> {
    let result = super.tryCall(
      "withdraw",
      "withdraw(uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__withdrawResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  withdrawMax(tokenId: BigInt): Contract__withdrawMaxResult {
    let result = super.call(
      "withdrawMax",
    ...
    return new Contract__withdrawMaxResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_withdrawMax(
    tokenId: BigInt
  ): ethereum.CallResult<Contract__withdrawMaxResult> {
    let result = super.tryCall(
      "withdrawMax",
      "withdrawMax(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__withdrawMaxResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
